...
class MakeTableTests(unittest.TestCase):
    ...
    def test_011_lots_of_columns(self) -> None:
        ...
        print(make_table(rows))
        print(make_table(rows, centered=True))

tests = MakeTableTests()
tests.test_001_parameters()
tests.test_002_return_type()
tests.test_003_creates_rows()
tests.test_004_creates_cols()
tests.test_005_creates_label()
tests.test_006_align_center()
tests.test_007_column_width_scaling()
tests.test_008_other_item_types()
tests.test_009_custom_objects()
tests.test_010_lots_of_rows()
tests.test_011_lots_of_columns()